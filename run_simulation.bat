...
start "Frontend Server" cmd /k "echo Frontend Window: Changing to frontend directory... && cd /d "%~dp0frontend" && echo Frontend Window: Installing Node.js dependencies (npm install)... && npm install && (call ) && echo Frontend Window: Starting SvelteKit dev server (npm run dev)... && npm run dev"
